	...
	\input{./produtos/prodtres/tp3_coberturarsu}
...
\end{description}
	...
	A somatória de quilômetros percorridos pelos caminhões para a coleta e disposição final de todos os tipos de resíduos do município é de aproximadamente 331 Km semanais. Sendo que os resíduos provenientes da coleta comum são levados até o município de Tremembé e os resíduos recicláveis até São José dos Campos.  
	...
	Outra opção também é realizar a reciclagem dos materiais coletados seletivamente dentro do próprio município, que evitaria o transporte dos mesmos até São José dos Campos, diminuindo aproximadamente 50 km semanais das rotas dos caminhões.
