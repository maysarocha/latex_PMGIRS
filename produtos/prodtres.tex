...
\end{figure}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.5\linewidth]{produtos/prodtres/image011}
		\caption{Caminhão utilizado na coleta do resíduo sólido comum.}
		\label{fig:image011}
	\end{figure}
	...
	Para a retirada dos resíduos das lixeiras é feita uma manobra com o caminhão, em que o mesmo se aproxima de ré até ficar bastante próximo da lixeira, como ilustram as \autoref{fig:image014} e \autoref{fig:image015}. A figura 12 também mostra a disposição inadequada dos resíduos sólidos no solo, fora da lixeira.
...
\end{figure}
	...
	\begin{figure}
		...
		\legend{REVERRRR!!!!! Fonte: Elaborado pelos autores.}
		\label{fig:image042}
	\end{figure}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.75\linewidth]{produtos/prodtres/image045}
		\caption{Caminhão utilizado na coleta do Resíduo Sólido Reciclável.}
		\legend{REVER!!!!! Fonte: SSM de Monteiro Lobato.}
		\label{fig:image045}
	\end{figure}
...
%	\input{./produtos/prodtres/tp3_custo_limpeza}
...
%o uso do parênteses na atribuição do rótulo coloca a numeração da	lista entre parênteses. Se não usado, não exibe parênteses		
	...
	Vale ressaltar que a elaboração e aplicação do plano de gerenciamento de resíduos sólidos não é afetada ou impedida diante da ausência do PMGIRS \cite{brasil:12305}.
	...
	De acordo com o artigo 4\textdegree\ da Resolução CONAMA n\textdegree\ 358/2005, compete aos órgãos ambientais do Município, do Estado e do Distrito Federal a determinação de critérios que definam quais estabelecimentos serão passíveis de licenciamento ambiental e de elaborar e implementar o PGRSS \cite{conama:362}.
	...
	Para o acondicionamento dos resíduos de cortantes e perfurocortantes, todos os estabelecimentos geradores utilizam o “Descarpack” apresentado na \autoref{fig:image065} que é disponibilizado pela UBS.
	...
	\begin{figure}
		...
		\legend{Fonte: Elaborado pelos autores.REVER!!! FALTA FOTO}
		\label{fig:image066}
	\end{figure}
