...
\newpage
	...
	\begin{itemize}
		...
		\item Alinhamento com os \gls{ods} da ONU (2015).
	\end{itemize}
	...
	\begin{itemize}
		...
		\item Indicadores adotados por \cite{castro_silva_marchand_2015} para a avaliação da gestão sustentável de resíduos sólidos de municípios no estado de Amazonas;
		\item Indicadores de sustentabilidade para a gestão municipal de \gls{rsu} desenvolvidos por \cite{polaz_2009}, para o estudo do município de São Carlos – SP;
		\item Sistema de Indicadores de resíduos sólidos elaborado pelo \gls{snis} \cite{snis_serie_2019}.
		\item Sistema de avaliação da gestão integrada de \gls{rcc} na esfera municipal proposto por \cite{lima_2012}.
	\end{itemize}
	...
	Tendo como base as principais características de um bom conjunto de indicadores, na opinião de diversos autores, de trabalhos avaliados por \cite{bellen_2002}, foram listados os seguintes critérios para a seleção dos indicadores para a gestão municipal de resíduos sólidos (o que inclui os serviços públicos de limpeza urbana e manejo dos resíduos sólidos):
