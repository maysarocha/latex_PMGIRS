...
\end{figure}
	...
	\begin{figure}
		...
		\caption{Materiais reciclÃ¡veis identificÃ¡veis por estarem sem acondicionamento nas lixeiras.}
		\legend{Fonte: Elaborado pelos autores.}
		\label{fig:image043}
	\end{figure}
...
\clearpage	
	...
	\begin{figure}
		...
		\legend{Fonte: Adaptado de DNPM, 2017.}
		\label{fig:image091}
	\end{figure}
...
\newpage
	...
	\begin{itemize}
		...
		\item Indicadores de sustentabilidade para a gestão municipal de \gls{rsu} desenvolvidos por Polaz e Teixeira (2009), para o estudo do município de São Carlos – SP;
