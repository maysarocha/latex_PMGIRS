...
\end{figure}
	...
	Ao analisar a \autoref{tab:pop_atendida} verifica-se a deficiência na declaração dos dados pelos municípios para o Sistema Nacional de Informações sobre Saneamento (SNIS). A ausência de dados consistentes ao longo da Série Histórica prejudica a interpretação e expõe uma fragilidade em relação a qualidade das informações.
...
\end{figure}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.6\linewidth]{produtos/prodtres/image052}
...
%o uso do parênteses na atribuição do rótulo coloca a numeração da	lista entre parênteses. Se não usado, não exibe parênteses		
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.75\linewidth]{produtos/prodtres/image063}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.75\linewidth]{produtos/prodtres/image064}
