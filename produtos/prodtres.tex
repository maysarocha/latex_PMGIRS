...
\colorbox{green}{FIGURA:Relação de disposição final dos RSU no Brasil em 2008}
...
%	\input{./produtos/prodtres/tp3_densidade_aparente}
...
%	\input{./produtos/prodtres/tp3_gasto_mensal}
...
%	\input{./produtos/prodtres/tp3_historico_custo}
...
%	\input{./produtos/prodtres/tp3_info_coleta}
	...
	\colorbox{green}{figura:Caminhão utilizado na coleta do Resíduo Sólido Reciclável}	
...
%	\input{./produtos/prodtres/tp3_tipo_rsu_ml}
...
%	\input{./produtos/prodtres/tp3_composicao_gravimetrica}
...
%	\input{./produtos/prodtres/tp3_densidade_aparente_seletiva}
	...
	\colorbox{green}{figura:Exemplos de resíduos cemiteriais}
...
%	\input{./produtos/prodtres/tp3_relacao_nbr}
...
%	\input{./produtos/prodtres/tp3_classificacao_rss}
...
%	\input{./produtos/prodtres/tp3_tratamento_rss}
	...
	De acordo com o artigo 4\textdegree\ da Resolução CONAMA n\textdegree\ 358/2005, compete aos órgãos ambientais do Município, do Estado e do Distrito Federal a determinação de critérios que definam quais estabelecimentos serão passíveis de licenciamento ambiental e de elaborar e implementar o PGRSS (CONAMA, 2005b).
...
%	\input{./produtos/prodtres/tp3_classe_rss}
	...
	\colorbox{green}{figura:Descarte de resíduos recicláveis, orgânicos e rejeitos no recipiente de resíduos sólidos da cozinha da UBS.}
	...
	\colorbox{green}{tabela:Classificação dos Resíduos de Construção Civil.}
	...
	\colorbox{green}{tabela:Informação sobre unidades de recebimento de RCC no Brasil}
...
\end{description}
	...
	\colorbox{green}{tabela:Indicadores para os Aspectos Legais dos Serviços de Limpeza Urbana}
